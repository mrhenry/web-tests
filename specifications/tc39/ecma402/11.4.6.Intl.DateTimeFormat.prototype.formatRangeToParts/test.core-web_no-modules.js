  ...
  if (!("Intl" in self && "Locale" in self.Intl)) {
    (function () {
      ...
      var __reExport = function __reExport(target, module, desc) {
        if (module && _typeof(module) === "object" || typeof module === "function") for (var keys = __getOwnPropNames(module), i = 0, n = keys.length, key; i < n; i++) {
          key = keys[i];
      ...
      var Locale = function () {
        function Locale2(tag, opts) {
          ...
          if (typeof tag !== "string" && _typeof(tag) !== "object") {
            throw new TypeError("tag must be a string or object");
          }

          var internalSlots;

          if (_typeof(tag) === "object" && (internalSlots = getInternalSlots(tag)) && internalSlots.initializedLocale) {
...
// EXTERNAL MODULE: ./node_modules/@mrhenry/core-web/modules/Intl.Locale.js
var Intl_Locale = __webpack_require__(9609);
