...
(function (global) {
  try {
    ...
    var pseudoClassHasInnerQuery = function pseudoClassHasInnerQuery(query) {
      var current = '';
      var depth = 0;
      var escaped = false;
      var inHas = false;
    ...
    var queryContainsScopePseudoClass = function queryContainsScopePseudoClass(query) {
      var current = '';
      var escaped = false;
    ...
    var charIsNestedMarkMirror = function charIsNestedMarkMirror(_char3, mark) {
      if (mark === '(' && _char3 === ')') {
        return true;
      }
    ...
    var splitSelector = function splitSelector(query) {
      var selectors = [];
      var current = '';
      var escaped = false;
      var quoted = false;
    ...
    var replaceAllWithTempAttr = function replaceAllWithTempAttr(query, callback) {
    ...
    var walkNode = function walkNode(rootNode, callback) {
    ...
    var polyfill = function polyfill(qsa, returnAfterFirst) {
      return function (selectors) {
