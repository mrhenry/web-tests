...
var es_symbol_description = __webpack_require__(817);
...
;// CONCATENATED MODULE: ./specifications/w3c/geometry-1/3.DOMRect.x/test.pure.js


(function (cb) {
  var domRect = new DOMRect();
  cb(typeof domRect.x !== "undefined");
})(callback);
})();
